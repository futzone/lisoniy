...
export function HomePage() {
  ...
  return (
    <div className="flex flex-col">
        ...
        <div className="container relative px-4 py-20 md:py-32">
          <div className="mx-auto max-w-4xl text-center">
            <motion.div
              ...
              className="mb-6"
            >
              <div className="inline-flex items-center gap-2 rounded-full border-2 border-primary/20 bg-primary/10 px-4 py-2 text-sm font-medium text-primary shadow-lg backdrop-blur-sm">
            ...
            >
              <h1 className="mb-6 pb-2 bg-gradient-to-r from-blue-600 via-purple-600 to-pink-600 bg-clip-text text-4xl font-bold tracking-tight text-transparent md:text-6xl">
                ...
                >
                  <Link to={feature.href}>
                    <Card className="group h-full overflow-hidden border-2 transition-all hover:shadow-xl hover:border-primary/50">
                      ...
                      <CardHeader>
                        <div className={`mb-3 inline-flex h-12 w-12 items-center justify-center rounded-xl bg-gradient-to-br ${feature.gradient} text-white shadow-lg transition-transform group-hover:scale-110`}>
              ...
              {testimonials.map((testimonial, index) => (
                ...
                >
                  <Card className="h-full border-2 transition-all hover:shadow-lg">
                    ...
                    <CardContent>
                      <Quote className="mb-2 h-6 w-6 text-muted-foreground" />
      ...
      {/* FAQ Section */}
      <section className="relative overflow-hidden bg-gradient-to-br from-slate-50 via-blue-50 to-purple-50 dark:from-slate-950 dark:via-blue-950/50 dark:to-purple-950/50 py-16 md:py-24">
        <div className="absolute inset-0 bg-grid-slate-900/[0.04] dark:bg-grid-slate-400/[0.05] bg-[size:20px_20px]" />
                    ...
                    <Card className="group h-full overflow-hidden border-2 transition-all hover:shadow-2xl hover:border-primary/50">
                      ...
                      <CardHeader className="pb-4">
                        <div className="mb-4 flex items-start justify-between">
                          <div className={`inline-flex h-12 w-12 flex-shrink-0 items-center justify-center rounded-xl bg-gradient-to-br ${faq.gradient} text-white shadow-lg transition-transform group-hover:scale-110 group-hover:rotate-6`}>
                            <Icon className="h-6 w-6" />
                          </div>
                        </div>
        ...
        {/* Decorative gradient orbs */}
        <div className="absolute -top-24 right-0 h-96 w-96 rounded-full bg-purple-500/20 blur-3xl" />
        <div className="absolute -bottom-24 left-0 h-96 w-96 rounded-full bg-blue-500/20 blur-3xl" />
      </section>
    </div>
  );
}